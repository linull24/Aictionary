    ...
    private async Task SearchAsync()
    {
        ...
        try
        {
            ...
            if (definition != null)
            {
                ...
                // Add to history with concise definition
                await _queryHistoryService.AddEntryAsync(query, DateTime.UtcNow, definition.ConciseDefinition);
            ...
            {
                // Add to history without definition
